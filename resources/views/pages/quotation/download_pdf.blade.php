                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <div class="my-2">
                                                    ...
                                                    {!! $quotation->status == 'Pending' ? '<span style="background-color: #ffc107;border-radius: 10rem;padding: 3px">'.$quotation->status.'</span>' : '<span style="background-color: #28a745;border-radius: 10rem;padding: 3px">'.$quotation->status.'</span>' !!}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
